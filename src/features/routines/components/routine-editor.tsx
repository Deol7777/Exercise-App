              ...
              <li key={line.id}>
                <Surface inset="sm" className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {/* The note is the sets-and-reps prescription a copied
                        prebuilt routine brings with it ("5×5"). Nothing else
                        writes one yet, so most rows show the muscle group
                        alone. */}
                    <p className="truncate text-xs text-muted-foreground">
                      {line.notes
                        ? `${MUSCLE_GROUP_LABELS[line.exercise.muscleGroup]} · ${line.notes}`
